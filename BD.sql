...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-02-2021 a las 14:22:24
...
--
ALTER TABLE `emprendimiento`
  ADD CONSTRAINT `emprendimiento-categoria` FOREIGN KEY (`categoria_id`) REFERENCES `categoria` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
